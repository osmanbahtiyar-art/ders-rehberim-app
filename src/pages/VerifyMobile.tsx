...
const VerifyMobile = () => {
  ...
  useEffect(() => {
    ...
    verificationApi.mobileStart(email)
      .then((res) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    setLoading(true);
    try {
      await verificationApi.mobileComplete(email, code);
    ...
    <div className="flex min-h-screen flex-col items-center justify-center bg-background px-6">
      <div className="w-full max-w-sm">
        ...
        <div className="mb-8 flex flex-col items-center">
          ...
          <h1 className="mt-4 text-xl font-bold text-foreground">Telefon Doğrulama</h1>
          <p className="mt-2 text-center text-sm text-muted-foreground">
            Kayıtlı telefon numaranıza 6 haneli kod gönderildi.
          </p>
          {codeIndex !== null && (
